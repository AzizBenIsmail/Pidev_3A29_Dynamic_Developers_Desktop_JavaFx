    ...
    public void initialize(URL url, ResourceBundle rb) {
      ...
      type.getSelectionModel().selectFirst();
       ...
       Modifier.setOnMouseClicked(m->{
        ...
        list=service.recupererUser(SessionManager.getId());
        //System.out.print(SessionManager.getEmail());
        ...
        Reclamer.setOnMouseClicked(event->{
       ...
       if (!(description.getText().equals("")) && !(objet.getText().equals("")) ){
           ...
           String cTEXT ="Le Client , "+SessionManager.getUserName()+" a ajouter une nouvelle reclamation avec un type ' "+type.getValue()+"'";
        ...
        Parent root = null;
          try {
              ...
              Logger.getLogger(ShowReclamationController.class.getName()).log(Level.SEVERE, null, ex);
          }
              Scene scene = new Scene(root);
